...
// Check connection
 ...
 if (isset($_POST['login'])){
	 ...
	 if($email=="")
	 {
		 echo "<script type='text/javascript'>alert('Please Enter Registered Email to View Pass')</script>";
	 }
	 else{
...
if($result = mysqli_query($mysqli, $sql)){
    if(mysqli_num_rows($result) > 0){
		...
		echo "<script type='text/javascript'>alert('No records matching to get your pass.')</script>";
